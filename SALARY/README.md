...
### 3. Model Training
Regression algorithms implemented include:
- Linear Regression
...
```bash
git clone https://github.com/SAPASHK-KS/MachineLearning-Phase2.git
```

### Navigate to the SALARY Folder

```bash
cd MachineLearning-Phase2/SALARY
```
